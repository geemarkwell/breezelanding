...
const Form = () => {
  ...
  const handleClick = () => {
    handleJoinWaitlist(); // Call the async function within a synchronous handler
  };
        ...
        <div className="flex justify-center">
          <div className="flex mt-6 flex-col md:flex-row">
            <div className="sm:col-span-4 mt-4">
              <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus:none sm:max-w-md mr-2">
                <input
                  type="email"
                  name="email"
                  id="email"
                  ...
                  className="w-72 h-12 rounded-md block flex-1 bg-transparent py-4 pl-4 text-white placeholder:text-gray-400 focus:none sm:text-md sm:leading-6 text-lg"
            ...
            <button
              ...
              className={`mx-auto text-white px-6 py-2 rounded-md shadow border font-medium mt-4 text-xl ${
                joined ? 'bg-green-700' : 'bg-blue-700 hover:brightness-90'
              }`}
            ...
            >
              ...
              ) : joined ? 'Joined' : 'Join Waitlist'} {/* Change button text based on state */}
            </button>
          </div>
        </div>
      </div>
